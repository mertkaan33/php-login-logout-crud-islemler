        ...
        <div class="row">
          <div class="col-lg-12 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="musteriListele.php" class="small-box-footer">Müsterileri görmek için tıkla <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-12 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="musteriEkle.php" class="small-box-footer">Müşteri Eklemek için tıkla <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
        <!-- /.row -->
